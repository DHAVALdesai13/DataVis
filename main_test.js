...
d3.csv('cars.csv', dataPreprocessor).then(function(dataset) {
        ...
        SplomCell.prototype.update = function(g, data) {
            ...
            //.domain(extentByAttribute[+data[chartScales.x]]);
            ...
            var dotsEnter = dots.enter()
                ...
                .style("fill", function(d) { 
                    if(chartScales.x == "cylinders"){
                        console.log("color");
                        console.log(colorScale(d.cylinders));
                        return colorScale(d.cylinders);
                    }
                     
                    else{
                    return colorScale1(+d[chartScales.x]);
                        }
                     })
                .attr('r', 4);
